...
// PATCH /api/commitments/[id] - Update a personal commitment
export async function PATCH(request: Request, context: RouteContext) {
  try {
    ...
    if (body.status && ['Pending', 'Partially Received', 'Fully Received', 'Cancelled'].includes(body.status)) {
      ...
      // Fetch current record if only one of promised/received is being changed
...
// DELETE /api/commitments/[id] - Delete a personal commitment
